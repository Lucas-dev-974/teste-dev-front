...
Deno.test("Does getThreeTopTestimonials return in descending order", () => {
  ...
  assertEquals(
    toTestTestimonials[0].rating,
    5,
    "Le premier témoignage est incorrect"
  );
  assertEquals(
    toTestTestimonials[1].rating,
    4,
    "Le deuxième témoignage est incorrect"
  );
  assertEquals(
    toTestTestimonials[2].rating,
    3,
    "Le troisième témoignage est incorrect"
  );
});
